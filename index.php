        ...
        <div class='container mt-5'>
            ...
            <?php
                ...
                foreach ($users as $user) {
                    ...
                    //     $city = '-';
                    // }
                    // нижняя запись полностью заменяет конструкцию с использованием функции if
                    // Знак вопроса (?) после присвоения к переменной проверяет на True или False
                    // И выбирает что присвоить к переменной. Если True - то значение до ":", 
                    // если False - то значение после ":"
